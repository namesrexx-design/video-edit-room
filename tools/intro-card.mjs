...
//
//   node tools/intro-card.mjs --out card.mp4 [--size 1920x1080|1080x1920] [--lines "a|b|c"] [--silent] [--seconds 7]
//
// Picture: black film ground with grain and a vignette, typewriter face (Special Elite, Apache-2.0, tools/fonts),
...
Style: Card,Special Elite,${size},&H00E6EBEE,&H00E6EBEE,&H00000000,&H64000000,0,0,0,0,100,100,1,0,1,0,2,8,40,40,0,1
...
const video = `color=c=0x0b0b0c:s=${W}x${H}:r=24:d=${SECONDS},format=yuv420p,noise=alls=10:allf=t,vignette=PI/4,ass='${esc(assPath)}':fontsdir='${esc(FONTS)}',fade=t=in:st=0:d=0.4,fade=t=out:st=${SECONDS - 0.5}:d=0.5[v]`;
