...
test('renderer-only change can retain bytes when the effective timeline is unchanged',()=>assert.equal(assertPreview({expectedCutSha:'C',fingerprint:'NEW-RENDERER',timelineFingerprint:'SAME-TIMELINE',actualOutputSha:'O',receipt:{cutSha256:'C',outputSha256:'O'},previous:{fingerprint:'OLD-RENDERER',timelineFingerprint:'SAME-TIMELINE',outputSha256:'O'}}),true));
