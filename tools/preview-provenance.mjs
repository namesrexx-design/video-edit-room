...
export function assertPreview({expectedCutSha, fingerprint, actualOutputSha, receipt, previous}) {
  ...
  if (previous?.fingerprint && previous.fingerprint !== fingerprint && previous.outputSha256 === actualOutputSha)
